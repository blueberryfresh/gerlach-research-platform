...
**Revision note**: This is revision 3 of this document. Earlier revisions described one or both pairing draws as plain, personality-independent random choices. Both have since been superseded — see [Revision History](#revision-history) at the bottom for why.
