...
EN = {
    ...
    "task_dial_guide": """\
**What you'll see:**
- Task document displayed on screen
- Chat interface with your assigned AI
- Message input box at the bottom

**What to do:**
1. Read the task document carefully
2. Start chatting with the AI about the task
3. Collaborate to complete the task together
4. Click "End Dialogue" when you're satisfied
...
KO = {
    ...
    "reg_intro": (
        "참여해 주셔서 감사합니다. 이 연구에서 참여하시는분는 다음을 수행하게 됩니다:\n\n"
        "1. 몇 가지 설문지에 응답\n"
    ...
    "big5_info": "이것은 참여하시는분라는 사람을 더 알기 위한 것입니다.",
    "big5_instructions": (
        "각 진술에 대해 참여하시는분가 일반적으로 어떤지를 바탕으로 얼마나 동의하거나 동의하지 않는지를 표시하십시오 — "
        "옳거나 틀린 답은 없습니다.\n\n"
    ...
    "task_dial_warning":         "⚠️ **참여하시는분와 LLM 파트너가 과제를 완전히 완료했을 때만 아래 버튼을 클릭하십시오!**",
    ...
    "task_dial_welcome_prompt": (
        "한국어로 짧고 친근한 환영 메시지로 협업을 시작해 주세요. "
        "참여자가 방금 과제 설명을 읽었음을 인지하고, "
        "초기 생각이나 어떻게 진행하고 싶은지 이야기해 달라고 초대해 주세요."
    ),
...
**해야 할 일:**
1. 과제 문서를 주의 깊게 읽으세요
2. 과제에 대해 AI와 대화를 시작하세요
3. 함께 협력하여 과제를 완료하세요
4. 만족스러우면 "대화 종료"를 클릭하세요
...
- 대화 중에 의견을 바꿔도 괜찮습니다
- AI는 참여하시는분를 테스트하는 것이 아니라 함께 일하기 위해 있습니다
...
Bob은 "이것이 쉬운 일이 아니라는 것을 알고 있지만, 현재 상황을 감안할 때 다른 선택이 없습니다." 라고 말하며 회의를 마쳤습니다. 그 시점에서 참여하시는분와 다른 수석 시스템 분석가들은 순위 지정 작업을 수행하기 위해 각자의 사무실로 돌아갔습니다.
